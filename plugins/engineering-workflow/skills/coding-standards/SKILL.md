...
- 阅读相关入口和周边实现。
- 读取项目上下文：`.codex/engineering-workflow/project/project-profile.md`、`.codex/engineering-workflow/project/domain.md`、`.codex/engineering-workflow/context.md`、相关 `.codex/engineering-workflow/adr/`；不存在时不阻塞，但不要凭空发明项目术语。
- 找到同项目中的相似代码。
