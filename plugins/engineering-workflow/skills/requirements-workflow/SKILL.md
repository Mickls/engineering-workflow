...
非轻量需求创建或更新 `design.md` / `plan.md` 前，检查 `.codex/engineering-workflow/project/*` 和 context；缺失、stale、超出 `scan_scope` 或命中 gap 时先使用 `project-setup`。细则见 [context-readiness.md](references/context-readiness.md)。
