...
8. differential loop：同一输入对比旧版本/新版本、两种配置或两个数据集。
9. bisect harness：当问题出现在两个已知状态之间时，用脚本配合 `git bisect run`。
10. 人机协作脚本，参考 [hitl-loop.template.sh](scripts/hitl-loop.template.sh)。
